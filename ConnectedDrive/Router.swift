...
public enum Router: URLRequestConvertible {
    ...
    static var APIKey: String {
        guard let info = Bundle.main.infoDictionary, APIKey = info["APIKey"] as? String else {
            fatalError("No API key found in Info.plist. Store Base64 encoded API key (looks similar to: a2V5OnNlY3JldA==). See also https://github.com/quentinsf/BMW-i-Remote")
        }
        return APIKey
    }
